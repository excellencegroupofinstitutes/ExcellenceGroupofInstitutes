...
const QuoteSection = () => {
  return (
    <section className="relative bg-gray-50 py-6 max-w-[1560px] mx-auto">
      <div className="max-w-4xl mx-auto text-center text-gray-900">
        ...
        {/* Quote Text */}
        <h2 className="text-3xl md:text-5xl lg:text-6xl font-[400] italic leading-snug text-secondary">
        ...
        <p className="mt-4 md:text-lg text-gray-900">
