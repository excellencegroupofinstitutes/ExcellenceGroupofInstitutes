      ...
      <div className="max-w-[1280px] hidden md:block mx-auto px-6 space-y-16 relative z-10">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-8">
          <div className="md:w-1/2 relative">
            ...
            <p className="text-base md:text-lg mt-2 leading-relaxed">
              From stunning websites to robust Ecommerce platforms and effective
              digital marketing strategies.
            </p>
            <div className="mt-5">
              <FancyButton navigation={() => navigate("/web-services")}>
                Read More
              </FancyButton>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="relative">
            ...
            />
            <div
              className="absolute -top-3 -right-3 w-4 h-4 bg-orange-200 opacity-60"
              style={{
                clipPath: "polygon(50% 0%, 0% 100%, 100% 100%)",
              }}
            ></div>
            <div
              className="absolute -bottom-5 -left-5 w-8 h-8 bg-red-200 opacity-50"
              style={{
          ...
          <div className="md:w-1/2 relative">
            ...
            <div className="mt-5">
              <FancyButton navigation={() => navigate("/computer-services")}>
                Read More
              </FancyButton>
            </div>
          </div>
      ...
      <div className="max-w-[475px] md:hidden mx-auto flex flex-col gap-10 p-2">
        ...
        <div className="flex gap-3 flex-col mx-2 shadow-2xl my-5">
          ...
          <div className="p-6">
            ...
            <button
              className="text-white bg-secondary transform transition-all rounded-sm duration-300 font-[500] py-[5px] hover:translate-y-1 hover:cursor-pointer w-full"
              onClick={() => navigate("/computer-services")}
            >
              Read More
            </button>
          </div>
