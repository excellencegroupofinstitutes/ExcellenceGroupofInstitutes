      ...
      <div className="max-w-[475px] md:hidden mx-auto flex flex-col gap-10  p-2 " >
        ...
        <div className="flex gap-3 flex-col mx-2 shadow-2xl my-5">
          ...
          <div className="p-6">
            ...
            <button className="underline" onClick={() => { navigate('/tuition') }}>Read More</button>
          </div>
        </div>
        ...
        <div className="flex gap-3 flex-col mx-2 shadow-2xl my-5">
          ...
          <div className="p-6">
            ...
            <button className="underline" onClick={() => { navigate('/web-services') }}>Read More</button>
          </div>
        </div>
        ...
        <div className="flex gap-3 flex-col mx-2 shadow-2xl my-5">
          ...
          <div className="p-6">
            ...
            <button className="underline" onClick={() => { navigate('/computer-services') }}>Read More</button>
          </div>
        </div>
