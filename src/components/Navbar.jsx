      ...
      <header className="shadow-md max-w-[1560px] mx-auto fixed top-0 right-0 left-0 z-50 bg-white transition-all duration-300">
        ...
        >
          <div className="text-[38px] font-bold text-primary">
            <Link to="/" className="flex items-center">
              ...
              <div>
              {/* <h2 className="text-[16px] md:text-2xl">Excellence</h2>
              <p className="text-[10px] md:text-[13px] text-gray-900 font-[400] ">Group</p> */}
        ...
        >
          ...
          <ul className="flex gap-4 text-primary text-[18px]">
            ...
            <Link to="/tuitions" className="hover:text-primary-hover list-item px-2 py-1">Tuitions</Link>
            <Link to="/computer-centre" className="hover:text-primary-hover list-item px-2 py-1">Computer Centre</Link>
