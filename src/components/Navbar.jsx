      ...
      <header className="shadow-md max-w-[1560px] mx-auto fixed top-0 right-0 left-0 z-50 bg-white transition-all duration-300">
        ...
        >
          ...
          <ul className="flex gap-4 text-primary text-[18px]">
            ...
            <Link to="/tuition" className="hover:text-primary-hover list-item px-2 py-1">Educational Institute</Link>
            ...
            >
              ...
              <ul className="flex flex-col gap-4 text-primary text-[18px]">
                ...
                <Link to="/tuition" onClick={() => setIsMenuOpen(false)}>
                  <span className="block hover:text-primary-hover px-2 py-1">Educational Institute</span>
                </Link>
