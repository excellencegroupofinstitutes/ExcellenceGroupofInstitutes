...
const row1 = [
    ...
    "/images/computer3.jpeg",
    "/images/computer_about.jpg",
    "/images/compView.jpeg",
    "/images/computer4.JPG",
];



export default function ComputerMarquee({
  height = "auto",
  gap = 16,
  images1 = row1,
}) {
  ...
  return (
    <section className="relative py-10 sm:py-14 bg-white mt-12">
